    ...
    while (!WindowShouldClose()) {
        ...
        if (gameState == 0) {
            ...
            if (IsKeyPressed(KEY_ONE)) {
                ...
                // 패들 및 공 초기화
                paddle = (Rectangle){ SCREEN_WIDTH / 2 - paddle.width / 2, SCREEN_HEIGHT - 50, paddle.width, 20 };
        ...
        if (gameState == 1) {
            ...
            char timerText[50];
            sprintf(timerText, "Time: %02d:%02d:%03d", minutes, seconds, milliseconds);
            DrawText(timerText, SCREEN_WIDTH - 200, SCREEN_HEIGHT - 40, 20, WHITE);
        ...
        if (gameState == 2) {
            ...
            DrawText("Restart press key 1\n Quit press key 0.", SCREEN_WIDTH / 2 - 200, SCREEN_HEIGHT / 2 + 40, 20, WHITE);
            EndDrawing();

            if (IsKeyPressed(KEY_ONE)) {
                gameState = 0; // 대기 상태로 돌아가기
            }
            if (IsKeyPressed(KEY_ZERO)) {
                break; // 게임 종료
            }
        ...
        if (gameState == 3) {
            BeginDrawing();
            ClearBackground(BLACK);
            DrawText("CONGRATULATION!!!", SCREEN_WIDTH / 2 - 150, SCREEN_HEIGHT / 2 - 20, 40, GREEN);
            DrawText("RESTART PRESS KEY 1 \n QUIT PRESS KEY 0", SCREEN_WIDTH / 2 - 200, SCREEN_HEIGHT / 2 + 40, 20, WHITE);
            EndDrawing();
